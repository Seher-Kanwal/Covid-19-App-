/// updated : 1646605628358
/// cases : 446299148
/// todayCases : 1113036
/// deaths : 6018601
/// todayDeaths : 3535
/// recovered : 379276312
/// todayRecovered : 1099460
/// active : 61004235
/// critical : 71404
/// casesPerOneMillion : 57256
/// deathsPerOneMillion : 772.1
/// tests : 5905969332
/// testsPerOneMillion : 748962.74
/// population : 7885531595
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 7736.22
/// recoveredPerOneMillion : 48097.75
/// criticalPerOneMillion : 9.06
/// affectedCountries : 226

class WorldStaticsModel {
  WorldStaticsModel({
      int? updated, 
      int? cases, 
      int? todayCases, 
  ...
  WorldStaticsModel.fromJson(dynamic json) {
